...
public class ProcessData {
	...
	private static int getKey(String str, String key) {
		Matcher matcher = Pattern.compile(key).matcher(str);
		if (matcher.find()) return 1;
		else return 0;
	}
	
	private static int getInitials(String str) {
		String[] tmp;
		tmp = str.split(" ");
		int flag=0;
	...
	private static int getPrepo(String str) {
	...
	public static void makeDataset(int mod) {
